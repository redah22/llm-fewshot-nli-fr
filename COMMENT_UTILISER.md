...
1. Lancez `python3 experiments/setup_data.py` et choisissez **4 (DACCORD)** ou **5 (RTE3-French)**.
...
```bash
python3 experiments/setup_xnli.py
```

**Étape B : Entraîner sur XNLI**
```bash
python3 experiments/train_flaubert_xnli.py
```
...
1. Lancez `python3 experiments/eval_flaubert.py`
